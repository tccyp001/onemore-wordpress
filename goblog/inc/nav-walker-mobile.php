 ...
 * @return      void
*/
function bpxl_add_custom_mobile_nav_fields( $menu_item ) {
...
add_filter( 'wp_setup_nav_menu_item', 'bpxl_add_custom_mobile_nav_fields' );
 ...
 * @return      void
*/
function bpxl_update_custom_mobile_nav_fields( $menu_id, $menu_item_db_id, $args ) {
 ...
 * @return      void
*/
function bpxl_edit_mobile_walker($walker,$menu_id) {

    return 'Walker_Mobile_Nav_Menu_Edit_Custom';
...
// edit menu walker
add_filter( 'wp_edit_nav_menu_walker', 'bpxl_edit_mobile_walker', 10, 2 );
 ...
 */
class Walker_Mobile_Nav_Menu_Edit_Custom extends Walker_Nav_Menu  {
	/**
	    ...
	    <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
	        ...
	        <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <p class="field-menu-icon description description-thin">
                    <label for="edit-menu-item-icon-<?php echo $item_id; ?>"><?php _e( 'Menu Icon','bloompixel' ); ?>
 ...
 * @return      void
*/
class bpxl_nav_walker_mobile extends Walker_Nav_Menu
{
      function start_el(&$output, $item, $depth = 0, $args = array(), $id = 0)
      {
           global $wp_query;
