            ...
            <div class="nm-row">
                ...
                <div class="col-xs-3">
                    <div class="nm-single-product-menu">
						<?php
							/* Product navigation */
							next_post_link( '%link', '<i class="nm-font nm-font-play flip"></i>', $navigate_same_term, array(), 'product_cat' );
							previous_post_link( '%link', '<i class="nm-font nm-font-play"></i>', $navigate_same_term, array(), 'product_cat' );
						?>
                    </div>
                </div>
            </div>
