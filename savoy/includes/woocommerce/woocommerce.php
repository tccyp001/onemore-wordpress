<?php
	...
	function nm_get_myaccount_link( $is_header = true ) {
		...
		return '<a href="' . esc_url( $myaccount_url ) . '" id="nm-menu-account-btn">' . $link_title . '</a>';
	}
	...
	if ( ! function_exists( 'nm_header_add_to_cart_fragment' ) ) {
		function nm_header_add_to_cart_fragment( $fragments ) {
			...
			$fragments['.nm-menu-cart-count'] = '<span class="nm-menu-cart-count count">' . $cart_count . '</span>';
